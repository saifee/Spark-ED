<template>
	<ul id="sidebarnav">
        ...
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/social" exact><i class="fas fa-share-alt fa-fw"></i> <span class="hide-menu">{{trans('configuration.social_network')}}</span></router-link></li>
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/system" exact><i class="fas fa-cogs fa-fw"></i> <span class="hide-menu">{{trans('configuration.system_configuration')}}</span></router-link></li>
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/mail" exact><i class="fas fa-envelope fa-fw"></i> <span class="hide-menu">{{trans('configuration.mail_configuration')}}</span></router-link></li>
        ...
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/sms" exact><i class="fas fa-comment fa-fw"></i> <span class="hide-menu">{{trans('configuration.sms')}}</span></router-link></li>
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/payment/gateway" exact><i class="fas fa-credit-card fa-fw"></i> <span class="hide-menu">{{trans('finance.payment_gateway')}}</span></router-link></li>
        <li v-show="configMenu && hasPermission('access-configuration')" v-if="getConfig('made') === 'saudi'"><router-link to="/configuration/authentication" exact><i class="fas fa-sign-in-alt fa-fw"></i> <span class="hide-menu">{{trans('auth.authentication')}}</span></router-link></li>
