            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <div class="action-buttons pull-right">
                        <router-link to="/communication/meeting" class="btn btn-info btn-sm"><i class="fas fa-list"></i> <span class="d-none d-sm-inline">{{trans('general.back')}}</span></router-link>
                    </div>
                </div>
            </div>
        </div>
