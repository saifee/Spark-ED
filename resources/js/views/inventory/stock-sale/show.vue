      ...
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3 class="text-themecolor">
            {{ trans('inventory_sale.stock_sale_detail') }}
        ...
        <div class="col-12 col-sm-6">
          <div class="action-buttons pull-right">
            ...
            >
              <i class="fas fa-list" /> <span class="d-none d-sm-inline">{{ trans('inventory_sale.stock_sale') }}</span>
            </router-link>
            <div class="btn-group">
              <button
                id="moreOption"
                      ...
                      <td colspan="2">
                        <div v-if="attachments.length">
                          <ul class="m-t-10 upload-file-list">
                            ...
                            >
                              <a
                                :href="`/stock/sale/${stock_sale.id}/attachment/${attachment.uuid}/download?token=${authToken}`"
                                class="no-link-color"
                              ><i :class="['file-icon', 'fas', 'fa-lg', attachment.file_info.icon]" /> <span class="upload-file-list-item-size">{{ attachment.file_info.size }}</span> {{ attachment.user_filename }}</a>
                            </li>
                          </ul>
                        </div>
                      </td>
