    ...
    <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
      ...
      >
        ...
        >
          ...
          <table
            id="table1"
            class="table table-striped  table-fw-widget dataTable no-footer table_block day-book"
            role="grid"
                            ...
                            this.reverseData.forEach(value=>{
                                if(value.amount){
                                    ...
                                    if(value.transaction_type!="expense"){
                                        ...
                                        if(value.transaction_type=="Receive"||value.transaction_type=="Sold" || value.transaction_type=="income" ){
                                            totalAmount = totalAmount + amount
                                        }else{

                                            if((value.type=="liability" || value.type=="asset")&& value.transaction_type=='Initial'){
                                    ...
                                    this.dataList[this.dataList.length-i]['total_amount']=totalAmount.toFixed(2)
                                    i++
