...
<script>
    ...
    export default {
        components : { basicDetail,parentDetail,contactDetail,documentDetail,accountDetail,qualificationDetail,terminationDetail,siblingDetail,promotionDetail,loginDetail,attendanceDetail,examReport,feeDetail,walletDetail },
        data() {
            return {
