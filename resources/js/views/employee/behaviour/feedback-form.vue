<template>
    <div class="row my-5">
        <div class="col-3 text-center" v-for="employee_skill in employee_skills">
          <v-badge
            bordered
            overlap
          ...
          >
            <v-avatar
                ...
                color="grey"
            >
                <v-icon dark>{{ employee_skill.skill_icon.name }}</v-icon>
            </v-avatar>
            <v-skeleton-loader
              v-else
              type="avatar"
          ...
          <div v-if="employee_skill.name">{{employee_skill.name}}</div>
          <div v-else>
              <v-skeleton-loader
                type="text"
              ></v-skeleton-loader>
