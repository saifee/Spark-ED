                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <datepicker v-model="attendanceForm.date_of_attendance" :bootstrapStyling="true" :disabledDates="disabled" :placeholder="trans('employee.date_of_attendance')" typeable></datepicker>
